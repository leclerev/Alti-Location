 ...
 */
final class Version20190116095947 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE availability (id_availability INT AUTO_INCREMENT NOT NULL, id_property INT NOT NULL, date DATETIME NOT NULL, PRIMARY KEY(id_availability)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
